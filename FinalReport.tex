...
\par The node elimination effect on real graph's average shortest path length is shown in Figure \ref{wikivote_elim}, and the output data is \href{https://github.com/leahwu/DCM_simulaiton_and_analysis/tree/master/output_data/wiki_vote}{here}.

\begin{figure}[!htbp]
\centering\includegraphics[width=10cm, height=8cm]{final_images/wikivote.png}
\label{wikivote_elim}
\caption{Node elimination effect on ASPL of Wiki-vote network.}
\end{figure}
